...
var aranta = require('../index')
  ...
  , LaggedFibonacci = aranta.Algo.LaggedFibonacci

describe('LaggedFibonacci', function () {
  it('should return the same numbers', function () {
    var rand1 = new Random(new LaggedFibonacci(12345))
      , rand2 = new Random(new LaggedFibonacci(12345))

    for (var i = 0; i < 512; i++) rand1.int().should.equal(rand2.int())
  })

  it('should return the same numbers after reset', function () {
    var rand = new Random(new LaggedFibonacci(12345))
      , num1 = []
      , num2 = []
